...
boucler = True                                                                                                        #Boolean boucle principale
tailleCase = 20
...
def fond():                                                                                                              #Fonction initialise fond du terrain
    ...
    pygame.draw.rect(fenetre,(0,100,0),pygame.Rect(info.current_w-200,0,200,200))                                         #haut droit vert
    pygame.draw.rect(fenetre,(0,0,100),pygame.Rect(0,info.current_h-200,200,200))                                         #bas gauche bleu
    pygame.draw.rect(fenetre,(100,100,0),pygame.Rect(info.current_w-200,info.current_h-200,200,200))                      #bas droit jaune
